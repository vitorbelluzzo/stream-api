...
//        Com a ajuda da Stream API, verifique se todos os números da lista são positivos e exiba o resultado no console.
        numeros.stream().filter(n -> n < 0).findAny().ifPresentOrElse(n -> System.out.println("lista possui numero negativo"), () -> System.out.println("lista não possui numero negativo"));


//        Desafio 4 - Remova todos os valores ímpares:
//        Utilize a Stream API para remover os valores ímpares da lista e imprima a lista resultante no console.
        System.out.println(numeros.stream().filter(n -> n % 2 == 0).collect(Collectors.toList()));

        //Desafio 5 - Calcule a média dos números maiores que 5:
        //Com a Stream API, calcule a média dos números maiores que 5 e exiba o resultado no console.
        OptionalDouble listaMediaMaiorQue5 = numeros.stream().filter(n -> n > 5).mapToInt(Integer::intValue).average();
        System.out.println(listaMediaMaiorQue5);

//        Desafio 6 - Verificar se a lista contém algum número maior que 10:
//        Utilize a Stream API para verificar se a lista contém algum número maior que 10 e exiba o resultado no console.
        numeros.stream().filter(n -> n > 10).findAny().ifPresent(System.out::println);
